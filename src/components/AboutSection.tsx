    ...
    <div className="container mx-auto px-6">
      ...
      >
        ...
        <h2 className="text-3xl sm:text-4xl font-heading font-bold mb-12">
          Why hire me for your next <span className="text-gradient">project</span>?
        </h2>
      </motion.div>
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        <motion.div
          ...
          viewport={{ once: true }}
          className="card-elevated p-1 rounded-2xl max-w-sm mx-auto lg:mx-0"
        >
          <img src={profileImg} alt="Navaneeth Nayak" className="rounded-xl w-full" loading="lazy" width={512} height={512} />
        </motion.div>
